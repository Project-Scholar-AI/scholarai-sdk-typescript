...
import { ClientOptions } from 'scholarai';
...
export { ClientOptions } from 'scholarai';
...
export function initMcpServer(params: {
  ...
  const client = new Scholarai(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new Scholarai({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
